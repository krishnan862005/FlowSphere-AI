...
export interface WsClientToServer {
  ...
  'workflow:join': { workflowId: string };
  'workflow:leave': { workflowId: string };
}
...
export interface WsServerToClient {
  ...
  'workflow:updated': { workflowId: string; userId: string };
}
...
// Using global NodeCategory definition
...
export interface WsServerToClient {
  ...
  'execution:log': ExecutionLog;
  'notification:new': Notification;
  'workflow:user_joined': { userId: string; socketId: string };
  'workflow:user_left': { userId: string; socketId: string };
}
